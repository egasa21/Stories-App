...
import com.lazzy.stories.data.local.dao.RemoteKeys
import com.lazzy.stories.data.local.dao.Stories
...
class StoriesRemoteMediator (
    ...
    override suspend fun load(
        ...
        try {
            val responseData = apiServices.getAllStories(page, state.config.pageSize).listStory
            ...
            database.withTransaction {
                ...
                database.storiesDao().insert(stories)
            }
            return MediatorResult.Success(endOfPaginationReached = endOfPaginationReached)
        }catch (exception: Exception){
            Log.d("RemoteMediator", "Error : $exception")
